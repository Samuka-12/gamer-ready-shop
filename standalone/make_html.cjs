...
<body class="min-h-screen flex flex-col antialiased">
          ...
          <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-5 shadow-xs">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="text-xs">
                ...
                <p class="text-gray-500 mt-0.5">+5 mil vendas · São Paulo, SP</p>
              </div>
            </div>
  ...
  <script>
    ...
    function calcularFrete() {
      ...
      if (cep.length === 8) {
        document.getElementById('frete-resultado').classList.remove('hidden');
      } else {
    ...
    document.getElementById('form-cep').addEventListener('blur', (e) => {
      ...
      if (val.length === 8) {
        document.getElementById('form-rua').value = "Avenida Paulista";
        document.getElementById('form-bairro').value = "Bela Vista";
        document.getElementById('form-cidade').value = "São Paulo";
      }
    });
  </script>
</body>
